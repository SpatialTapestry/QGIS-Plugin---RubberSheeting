...
class RubberSheetingEtc:
    ...
    def select_PG_TestDB(self):
        ...
        try:
            ...
            level=Qgis.Warning, duration=13)
    ...
    def select_btn_Delete_SelectedThemes(self):
        try:
            ...
            self.iface.messageBar().pushMessage("Failured to delete table", err, level=Qgis.Warning, duration=3)
            return False
    ...
    def select_btn_Load_SelectedThemes(self):
        try:
            ...
            self.iface.messageBar().pushMessage("Failure loading theme", err, level=Qgis.Warning, duration=3)
            return False
...
def showProjectFile(self):
    try:
        ...
        self.iface.messageBar().pushMessage("Failure", err, level=Qgis.Warning, duration=3)
        return False
...
#create schema test123 AUTHORIZATION rogermsu;
        ...
        for f in vl.getFeatures():
            ...
            if ncount <= 2000:
                ...
                didBind = False
                if (DatabaseType == "ORA" or DatabaseType == "ORD") and len(geom_asWkt) > 4000:
                    ...
                    bindSt = bindSt + " v_sql varchar2(" + str(len(geom_asWkt) + len(newTblName) + 150) + ")" + chr(140) + chr(141)
                    bindSt = bindSt + " v_clob clob" + chr(140) + chr(141)
                    bindSt = bindSt + "begin" + chr(141)
                    bindSt = bindSt + "  v_clob := CAST('" + geom_asWkt + "' as clob)" + chr(140) + chr(141)
